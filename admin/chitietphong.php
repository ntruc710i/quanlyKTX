<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
      $idphong=$_POST['id'];
      $dt->select("SELECT * FROM phong WHERE phong.id_phong='$idphong'");
      $r = $dt->fetch();
      $phong=$r['phong'];
    }
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Danh Sách Sinh Viên Phòng <?php echo $phong ?></h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                      ...
                      <div class="card-header border-bottom">
                       ...
                       <div class="card-body p-0 pb-3 text-center">
                        <table class="table mb-0">
                          ...
                          <tbody>
                            <?php 
                                $dt->select("SELECT * FROM sinhvien INNER JOIN khoa ON sinhvien.id_khoa = khoa.id_khoa INNER JOIN giuong ON sinhvien.id_giuong=giuong.id_giuong where giuong.id_phong='$idphong'");
                                $i = 0;
                                while($r = $dt->fetch()){
                                    $i++;
                                    $id = $r['id_sinhvien'];
