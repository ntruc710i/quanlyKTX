                        ...
                        <table class="table mb-0">
                          <thead class="bg-light">
                            <tr>
                              ...
                              <th scope="col" class="border-0">Nội dung cần sữa chữa</th>
                          ...
                          <tbody>
                            <?php 
                                $dt->select("SELECT * FROM suachua INNER JOIN phong ON suachua.id_phong = phong.id_phong ");
                                $i = 0;
                                while($r = $dt->fetch()){
                                    $i++;
                                    $id = $r['id_suachua'];
